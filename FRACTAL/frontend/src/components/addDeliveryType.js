...
export default class RegisteDeliveryType extends Component {
    ...
    onSubmit = async(e) => {
        ...
        await axios.post("http://localhost:5000/api/deliveryType", {

            deliveryTypeName: this.state.name
